...
def test_find_by_id(db_session):
    award = Award(
        id=6, title="Award 6", producers="Producer 6", year=2005, winner=False
    )
...
def test_delete_by_id(db_session):
    award = Award(
        id=8, title="Award 8", producers="Producer 8", year=2007, winner=False
    )
    db_session.add(award)
    db_session.commit()
...
def test_get_winner(db_session):
    award1 = Award(
        id=9, title="Award 9", producers="Producer 9", year=2008, winner=True
    )
    award2 = Award(
        id=10, title="Award 10", producers="Producer 9", year=2010, winner=True
    )
    award3 = Award(
        id=11, title="Award 11", producers="Producer 11", year=2012, winner=True
    )
    award4 = Award(
        id=12, title="Award 12", producers="Producer 9", year=2014, winner=True
    )
    award5 = Award(
        id=13, title="Award 13", producers="Producer 9", year=2016, winner=True
    )
